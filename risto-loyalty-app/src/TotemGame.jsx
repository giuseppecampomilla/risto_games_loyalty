       ...
       return (
         <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-8 py-12">
             ...
             <div className="text-center space-y-2">
                 <h2 className="font-headline text-3xl font-bold uppercase tracking-tighter text-white">Lobby</h2>
      ...
      <div className="flex flex-col flex-1 space-y-3 animate-[fade-in_0.5s_ease-out] relative">
        ...
        <section className="grid grid-cols-2 gap-3">
          {getLeaderboard().slice(0, 2).map((p, index) => (
             <div key={p.id} className={`relative p-4 rounded-xl border-l-4 overflow-hidden shadow-lg ${
                p.isMe ? 'bg-secondary/10 border-secondary' : 'bg-surface-container-low border-primary/40'
             }`}>
